...
const Login = (props) => {
  ...
  return (
    <div className="m-auto inline-flex flex-col space-y-6">
      <img
        src={Log}
        alt="men with messages"
        className="inline-block bg-cover max-w-md"
      />
      <GoogleLogin
        ...
        render={(renderProps) => (
          <button
            className="focus:outline-none inline-flex space-x-5 items-center p-2 shadow-md rounded w-full justify-center"
